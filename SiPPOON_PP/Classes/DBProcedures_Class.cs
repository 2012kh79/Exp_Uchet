...
namespace SiPPOON_PP
{
    class DB_Procedures
    {
        ...
        public void spOtchet_Analisys_Insert(string Naim_Object, int Kol_Object, double Ploshad_Object, double Percent_One, double Metr_One, double Percent_Two, double Metr_Two,
            double Percent_Three, double Metr_Three, double Percent_Four, double Metr_Four, double Percent_PPCBN, double Metr_PPCBN, string Data_Otchet, Int32 Employee_ID)//Метод для добавления объекта обследования
        {
            spConfiguration("Object_Obsledovaniya_Insert");
            try
            {
        ...
        public void spOtchet_Analisys_Delete(Int32 ID_Analisys)//Метод для удаления объекта обследования
        {
            spConfiguration("Object_Obsledovaniya_Delete");
            try
            {
